...
import { Animation, KanbanColumnOrientation, KanbanColumnEditMode, KanbanDataSourcePriority, KanbanHeaderPosition, KanbanHierarchy, KanbanSelectionMode, KanbanTaskPosition, KanbanColumn, KanbanDataSource, KanbanSwimlane, KanbanUser} from './../../index';
...
export class Kanban extends React.Component<React.HTMLAttributes<Element> & KanbanProps, any> {   
  ...
  */
	...
	* @returns {any}
  */
	public async getColumn(dataField:string) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
