...
export interface WaitWindowProps extends WindowProperties {
    className?: string;
...
*/
export class WaitWindow extends React.Component<React.HTMLAttributes<Element> & WaitWindowProps, any> {   
	private _id: string;
  ...
  */
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-wait-window", { ref: this.componentRef }, this.props.children)
		)
	}
}
