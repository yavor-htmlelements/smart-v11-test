...
export class GanttChart extends React.Component {
	...
	*  @param event. The custom event. 	*/
	_onScrollLeftReached = null;	get onScrollLeftReached() {
		return this._onScrollLeftReached;
	}
	set onScrollLeftReached(value) {
		this._onScrollLeftReached = value;
	}
	/**  This event is triggered when the Timeline has been scrolled to the end (horizontally).
	*  @param event. The custom event. 	*/
	_onScrollRightReached = null;	get onScrollRightReached() {
		return this._onScrollRightReached;
	}
	set onScrollRightReached(value) {
		this._onScrollRightReached = value;
	}
  ...
  */
	...
	* @returns {any}
  */
	async getTaskConnections(taskId) {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
  ...
  */
	async insertTask(taskObject, project, index) {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
