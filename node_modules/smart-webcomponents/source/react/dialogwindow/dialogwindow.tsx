...
*/
export class DialogWindow extends React.Component<React.HTMLAttributes<Element> & DialogWindowProps, any> {   
	private _id: string;
  ...
  */
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-dialog-window", { ref: this.componentRef }, this.props.children)
		)
	}
}
