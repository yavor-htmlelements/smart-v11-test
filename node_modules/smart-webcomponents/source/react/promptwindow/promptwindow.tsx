...
export interface PromptWindowProps extends WindowProperties {
    className?: string;
...
*/
export class PromptWindow extends React.Component<React.HTMLAttributes<Element> & PromptWindowProps, any> {   
	private _id: string;
  ...
  */
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-prompt-window", { ref: this.componentRef }, this.props.children)
		)
	}
}
