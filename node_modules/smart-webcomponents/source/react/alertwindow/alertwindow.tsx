...
export interface AlertWindowProps extends WindowProperties {
    className?: string;
...
*/
export class AlertWindow extends React.Component<React.HTMLAttributes<Element> & AlertWindowProps, any> {   
	private _id: string;
  ...
  */
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-alert-window", { ref: this.componentRef }, this.props.children)
		)
	}
}
