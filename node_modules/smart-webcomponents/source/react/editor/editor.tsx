...
export class Editor extends React.Component<React.HTMLAttributes<Element> & EditorProps, any> {   
	...
	* @returns {boolean}
  */
	public async executeCommand(commandName:string, value?:string | number) : Promise<any> {
  ...
  */
	public async showMessage(message:string, settings?:any) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
  ...
  */
	public async updateToolbarItem(name:string | number, settings:any) : Promise<any> {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
