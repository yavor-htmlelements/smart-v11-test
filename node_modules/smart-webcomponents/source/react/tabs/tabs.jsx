...
export class Tabs extends React.Component {
	...
	*  @param event. The custom event. 	*/
	_onAddNewTabClick = null;	get onAddNewTabClick() {
		return this._onAddNewTabClick;
	}
	set onAddNewTabClick(value) {
		this._onAddNewTabClick = value;
	}
	...
	*/
	...
	get eventListeners() {
		return ["onAddNewTabClick","onChange","onClose","onClosing","onDragEnd","onDragStart","onReorder"];
	}
