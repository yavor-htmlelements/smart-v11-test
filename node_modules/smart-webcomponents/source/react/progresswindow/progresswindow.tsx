...
export interface ProgressWindowProps extends WindowProperties {
    className?: string;
...
*/
export class ProgressWindow extends React.Component<React.HTMLAttributes<Element> & ProgressWindowProps, any> {   
	private _id: string;
  ...
  */
	...
	*/
	...
	render() {
		return (
			React.createElement("smart-progress-window", { ref: this.componentRef }, this.props.children)
		)
	}
}
