...
export class MultiSplitButton extends React.Component {
	...
	*  @param event. The custom event. 	*/
	_onButtonClick = null;	get onButtonClick() {
	...
	*  @param event. The custom event. 	*/
	...
	get eventListeners() {
		return ["onButtonClick","onChange","onClose","onClosing","onItemClick","onOpen","onOpening","onScrollBottomReached","onScrollTopReached"];
	}
