...
export class Table extends React.Component {
	...
	*/
	_onCloseColumnMenu = null;	get onCloseColumnMenu() {
		return this._onCloseColumnMenu;
	}
	set onCloseColumnMenu(value) {
		this._onCloseColumnMenu = value;
	}
	...
	*   dataField - The data field of the column.
	*/
	_onOpenColumnMenu = null;	get onOpenColumnMenu() {
		return this._onOpenColumnMenu;
	}
	set onOpenColumnMenu(value) {
		this._onOpenColumnMenu = value;
	}
	...
	*/
	...
	get eventListeners() {
		return ["onCellBeginEdit","onCellClick","onCellEndEdit","onChange","onCollapse","onExpand","onColumnClick","onCloseColumnMenu","onColumnResize","onFilter","onGroup","onOpenColumnMenu","onPage","onRowBeginEdit","onRowEndEdit","onSort"];
	}
  ...
  */
	...
	* @returns {any}
  */
	async getColumnProperty(columnDataField, propertyName) {
		const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
